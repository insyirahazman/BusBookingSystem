...
public class AdminLogin{
    ...
    private void loginAdmin() {
        ...
        try (Connection con = ConnectionProvider.getCon()) {
            ...
            String query = "SELECT userID, username FROM users WHERE username = ? AND password = ? AND userType = 'ADMIN'";
            PreparedStatement stmt = con.prepareStatement(query);
            stmt.setString(1, username);
            stmt.setString(2, password);  // TODO: Use hashed passwords
            ...
            if (rs.next()) {
                ...
                new AdminDashboard(adminID, adminName).setVisible(true); // Open Admin Dashboard
            } else {
